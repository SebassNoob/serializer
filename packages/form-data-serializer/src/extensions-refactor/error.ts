 ...
 *
 * const data = { error };
 * const formData = serialize(data, { extensions: [ErrorExtension] });
 * const restored = deserialize(formData, { extensions: [ErrorExtension] });
 *
 ...
 * };
 *
 * const formData = serialize(errors, { extensions: [ErrorExtension] });
 * const restored = deserialize(formData, { extensions: [ErrorExtension] });
 *
