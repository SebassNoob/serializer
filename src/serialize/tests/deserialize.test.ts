...
describe('deserialize', () => {
  ...
  describe('extension handling', () => {
    ...
    test('should fail when extension is missing during deserialization', () => {
      ...
      expect(() => deserialize(serialized, [])).toThrow("Extension 'date' not found in provided extensions");
    });
  ...
  describe('round-trip consistency', () => {
    test('should maintain data integrity through serialize/deserialize cycle', async () => {
      ...
      const deserialized = deserialize(serialized, [dateExtension, bigIntExtension]) as typeof originalData;
  ...
  describe('error handling', () => {
    ...
    test('should throw error when extension data is missing', () => {
      ...
      expect(() => deserialize(formData)).toThrow('Extension data not found for key: $ext:missing:id');
    });
    ...
    test('should throw error when file hole contains non-Blob', () => {
      ...
      expect(() => deserialize(formData)).toThrow("Expected Blob for file hole key '\$ref:test-id', but got string");
    });
    ...
    test('should throw error when extension data has invalid JSON', () => {
      ...
      expect(() => deserialize(formData)).toThrow("Failed to parse extension data for key '\$ext:test:id'");
    });
    ...
    test('should handle file hole with null/undefined blob data', () => {
      ...
      expect(() => deserialize(formData)).toThrow('Expected Blob for file hole key \'$ref:test-id\', but got object');
    });
  });
  ...
  describe('edge cases', () => {
    ...
    test('should handle deeply nested structures', () => {
      ...
      expect(result.level1.level2.level3.level4.level5.value).toBe(deepObj.level1.level2.level3.level4.level5.value);
